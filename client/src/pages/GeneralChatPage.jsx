  ...
  return (
    <div className="flex-1 flex flex-col h-full min-h-0 bg-[#18181b] text-slate-100 overflow-hidden font-sans select-none antialiased min-w-0 max-w-full relative">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 p-3 sm:p-4 md:p-8 space-y-4 sm:space-y-6 min-w-0 max-w-full overflow-x-hidden pb-4">
              ...
              <div className="flex flex-col items-end space-y-2 max-w-[85%] md:max-w-xl min-w-0">
                ...
                <div className="flex items-center space-x-2 text-xs text-zinc-400 opacity-90 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="hover:text-white flex items-center space-x-1.5 bg-[#222226] hover:bg-[#2a2a30] px-3 py-1 rounded-lg border border-[#383842] text-zinc-300 font-semibold transition cursor-pointer"
                  ...
                  <button
                    ...
                    className="hover:text-rose-400 flex items-center space-x-1.5 bg-[#222226] hover:bg-rose-950/40 px-3 py-1 rounded-lg border border-[#383842] hover:border-rose-900/60 text-zinc-300 font-semibold transition cursor-pointer"
        ...
        {loading && (
          <div className="flex items-center space-x-3 max-w-5xl mx-auto pl-2">
            <div className="w-10 h-10 rounded-xl bg-[#222226] border border-[#383842] flex items-center justify-center text-white shrink-0 shadow-md">
              <Bot className="w-5 h-5 text-white animate-pulse" />
            </div>
            <div className="px-5 py-3.5 bg-[#222226] border border-[#2e2e36] rounded-2xl text-xs md:text-sm font-semibold text-indigo-400 flex items-center space-x-2">
